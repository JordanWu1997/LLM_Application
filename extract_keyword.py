...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Extract keyword in markdown files w/ Ollama")
    parser.add_argument("input_markdown_file_paths",
                        nargs="+",
                        help="Input markdown file paths")
    parser.add_argument(
        "--host",
        type=str,
        default="localhost",
    ...
    tag_file_path = None
    if os.path.isfile(args.tag_file_path):
